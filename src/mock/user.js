...
module.exports = {
  ...
  [`POST ${apiPrefix}/user/login`] (req, res) {
    ...
    if(user.length === 0){
      res.json({ code:1001, msg: '用户名不存在！' })
    }else if(user[0].password === password){
      res.json({ code:1000, data: 'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJhZG1pbiIsImNyZWF0ZWQiOjE1MDkzNDc5MTA3MTcsImV4cCI6MTUwOTk1MjcxMH0.sEqXWWM3Mj0Lyhc2vW9IS0vbt8mwGOHPTzeyQA1fCPddqQ-E393a4zLoFAicrgw8W6Na-9iHuxv1JjGsIfkBzw', msg: '请求成功' })
    } else {
      res.json({ code:1002, msg: '帐号或密码错误！' })
      //res.status(400).end()
    }
  },
